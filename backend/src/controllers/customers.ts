...
export const getCustomers = async (
    ...
    try {
        ...
        const normaizedLimit = (limit: any): number => {
        ...
        const options = {
            sort,
            skip: (Number(page) - 1) * Number(normaizedLimit),
            limit: Number(normaizedLimit),
        }
        ...
        const totalPages = Math.ceil(totalUsers / Number(normaizedLimit))
        ...
        res.status(200).json({
            ...
            pagination: {
                ...
                pageSize: Number(normaizedLimit),
            },
        })
    } catch (error) {
        next(error)
